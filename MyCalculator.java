...
public class MyCalculator extends Frame
{
    ...
    final int FRAME_WIDTH=460,FRAME_HEIGHT=430;
    final int HEIGHT=50, WIDTH=57, H_SPACE=10,V_SPACE=10;
    final int TOPX=30, TOPY=50, L_WIDTH=400 , L_HEIGHT = 40;
    ///////////////////////////
    MyCalculator(String frameText)//constructor
    {
        super(frameText);

        int tempX=TOPX, y=TOPY + 5;
        displayLabel.setBounds(tempX,y,L_WIDTH,L_HEIGHT);
        displayLabel.setBackground(Color.BLUE);
        displayLabel.setForeground(Color.WHITE);
        displayLabel.setFont(new Font("Arial", 1, 18));
        add(displayLabel);
...
// set Co-ordinates for Memory Buttons
        ...
        for(int i=0; i<memoryButton.length; i++)
        {
            ...
            memoryButton[i].setFont(new Font("Arial", 0,14));
            y+=HEIGHT+V_SPACE;
        }

//set Co-ordinates for Special Buttons
        tempX=TOPX+(WIDTH+H_SPACE); y=TOPY+1*(HEIGHT+V_SPACE);
        for(int i=0;i<specialButton.length;i++)
        {
            specialButton[i]=new MySpecialButton(tempX,y,WIDTH*2-9,HEIGHT,specialButtonText[i], this);
            specialButton[i].setForeground(Color.RED);
            specialButton[i].setFont(new Font("Arial", 0,14));
            tempX=tempX+2*WIDTH+H_SPACE-9;
        }
...
//set Co-ordinates for Digit Buttons
        ...
        for(int i=0;i<digitButton.length;i++)
        {
            ...
            digitButton[i].setFont(new Font("Arial", 0,14));
            tempX+=WIDTH+H_SPACE;
...
//set Co-ordinates for Operator Buttons
        ...
        for(int i=0;i<operatorButton.length;i++)
        {
            ...
            operatorButton[i].setFont(new Font("Arial", 0,14));
    ...
    {
        new MyCalculator("Calculator - JavaProject");
    }
}
